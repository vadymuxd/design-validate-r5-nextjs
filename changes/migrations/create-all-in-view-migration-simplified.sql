-- ============================================================================
-- MIGRATION: Create "All in" View for Tools Page (SIMPLIFIED VERSION)
-- Date: August 28, 2025
...
LEFT JOIN tool_pros_and_cons tpc ON tl.tool_id = tpc.tool_id AND tpc.method_id = 0
WHERE tl.method_id = 0
...
-- 3. Update voting logic to handle votes for method_id = 0
...
-- 7. Future votes on "all-in" view will be stored with method_id = 0
-- 8. Aggregation should be recalculated when new method-specific votes come in
-- 9. IMPORTANT: Use method_id = 0 for all "All in" view references in code
-- ============================================================================
